  ...
  return (
    <div className="relative">
      ...
      <div className="absolute right-[200px] top-1/2 transform -translate-y-1/2 w-[600px]">
        <h1 className="font-bold text-[32px] pb-4 leading-10">
          TRENDSETTING WARDROBE ADDITIONS
        </h1>
        <p className="text-xl pb-3">
          Explore our newest collection and elevate your wardrobe with our
          premium quality garments. Limited time offer! Grab these newest
